...
class JointStateSubscriber(Node):
    def __init__(self):
        ...
        # 加载模型
        self.model = mujoco.MjModel.from_xml_path('/home/ros-24/ros2_so_arm101/mujoco_simulation/trs_so_arm101/scene.xml')
        ...
        self.window = glfw.create_window(1200, 900, 'so Arm101 Control', None, None)
        if not self.window:
            glfw.terminate()
            return
        ...
        # 找到末端执行器的 body id
        self.end_effector_id = mujoco.mj_name2id(self.model, mujoco.mjtObj.mjOBJ_BODY, 'moving_jaw_so101_v1')
